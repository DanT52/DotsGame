 ...
 */
 ...
 public class NetDot extends JFrame {
	 ...
	 private DotsGameBoard gameBoard;
	 private JLabel gridSizeL;
	 private JSlider slider;
	 private JLabel boxesSizeText;
	 ...
	 private JLabel connectToLabel;
	 private JTextField connectToField;
	 private JLabel labelAboveBoard;
	 private JLabel scoreL;
	 private JLabel scoreL_1;
	 ...
	 public NetDot() {
		 ...
		 gameBoard = new DotsGameBoard(); //create gameboard
	 ...
	 public void createServer()//create the ServerPortal with port 1234
	   {	try {	ss=new ServerSocket(1234);
		 ...
		 System.out.println("connectedlol");
 
	   }
	 
	 public void createClient()//create ClientPortal with port 1234
	   {	try {	socket=new Socket(connectToField.getText(),1234);
	   }catch(Exception e) {
	 ...
	 public void mouseClickedHandle(int x, int y) {
